...
int main( int argc, char *argv[] ) {
  ...
  for (int row = 0; row < v_pix_h; row++) {
    ...
    for (int col = 0; col < v_pix_w; col++) {
      ...
      Pixel_t *obj_illum = new Pixel_t(0.2 * obj_hit->hit_color.r,
                                       0.2 * obj_hit->hit_color.g,
                                       0.2 * obj_hit->hit_color.b);
                                       
      // If object hit, do lighting, and set pixel value to color values
